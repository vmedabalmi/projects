...
// Data is passed from a server wrapper — but for simplicity with static
// export, we import mockPatents directly in client component
import { mockPatents } from "@/lib/mockPatents";
...
function BrowseInner({ patents }: { patents: PatentDisplayRecord[] }) {
...
export default function BrowsePage() {
  // We use mock + real data. In a client component, we import mockPatents
  // directly. In production, this would be fetched from an API.
  return <BrowseInner patents={mockPatents} />;
}
